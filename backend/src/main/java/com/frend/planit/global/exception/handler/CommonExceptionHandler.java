...
public class CommonExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNoResourceFoundException(
        ...
        return ResponseEntity
                .status(ErrorType.NO_RESOURCE_FOUND.getCode())
                .body(new ErrorResponse(ErrorType.NO_RESOURCE_FOUND.getMessage(), List.of(detail)));
    }
    ...
    public ResponseEntity<ErrorResponse> handleException(Exception exception) {
        ...
        return ResponseEntity
                ...
                .body(new ErrorResponse(ErrorType.COMMON_SERVER_ERROR.getMessage(),
                        List.of(detail)));
    }
}